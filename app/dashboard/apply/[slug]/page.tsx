    ...
    return (
      <div className="flex justify-center items-center py-40">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-red-500 mb-2">Maaf, Lowongan Ditutup</h1>
          <p className="text-muted-foreground">Posisi ini sudah tidak menerima lamaran baru.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 md:px-0">
      <div className="mb-8 p-6 bg-primary/5 rounded-2xl border border-primary/20">
        <h1 className="text-3xl font-bold tracking-tight">Formulir Pendaftaran</h1>
        <p className="text-muted-foreground mt-2">
          Anda sedang melamar untuk posisi: <strong className="text-foreground text-lg">{lowongan.title}</strong>
        </p>
