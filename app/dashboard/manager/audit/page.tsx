      ...
      <Card className="border-border shadow-md">
        <CardHeader className="text-center pb-8 pt-10">
          ...
          <CardTitle className="text-2xl md:text-3xl font-bold tracking-tight">
            Audit Member Nismara
          </CardTitle>
          <CardDescription className="text-base mt-3 max-w-md mx-auto">
            Pencarian manual profil anggota. Masukkan Discord ID pengguna untuk
            melihat status, role, histori Trucky, dan riwayat lamarannya.
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex justify-center border-t border-border/50 bg-muted/20 py-5 text-sm text-muted-foreground text-center px-6">
          <p>
            TIPS: Pastikan kamu memasukkan <strong>Discord ID</strong> (berupa
            18-19 digit angka), bukan username.
          </p>
        </CardFooter>
      </Card>
    </div>
